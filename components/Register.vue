    ...
    <ScrollView>
		<FlexboxLayout class="page">
			<StackLayout class="form">
				<Image class="logo" src="~/assets/images/logo.png" with="30"/>
				...
				<StackLayout v-show="!isLoggingIn" class="input-field">
          <DatePicker ref="birthdate" class="input" hint="Confirm password" v-model="user.birthdate">
					<StackLayout class="hr-light" /></StackLayout>

				<Button :text="isLoggingIn ? 'Log In' : 'Sign Up'" @tap="submit" class="btn btn-primary m-t-20" />
        <Button v-show="isLoggingIn" :text="'\uf099' +' Continue with Twitter'" @tap="loginTwitter" class="fab btn btn-active" />
        <Button v-show="isLoggingIn" :text="'\uf09a' +' Continue with Facebook'" @tap="loginFacebook" class="fab btn btn-active" />
        <Button v-show="isLoggingIn" :text="'\uf1a0' +' Continue with Google' " @tap="loginGoogle" class="fab btn btn-active" />
...
const userService = {
  async loginTwitter(user) {
       await firebase
        .login({
          type: firebase.LoginType.TWITTER
        })
        .then(result => {
          console.dir(result);
  ...
  async loginFacebook(user) {
    console.log('userService.loginFacebook');
      await firebase
        .login({
